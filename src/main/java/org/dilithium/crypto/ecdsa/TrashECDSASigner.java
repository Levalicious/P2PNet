...
public class TrashECDSASigner implements ECConstants, DSA {
    private final DSAKCalculator kCalculator;
    private ECKeyParameters key;
    private SecureRandom random;

    public TrashECDSASigner() {
        this.kCalculator = new RandomDSAKCalculator();
    }

    public TrashECDSASigner(DSAKCalculator var1) {
    ...
    public BigInteger[] generateSignature(byte[] var1) {
        ...
        do {
            ...
            do {
                ...
                System.out.println("K Value: " + var9.toString(16));
