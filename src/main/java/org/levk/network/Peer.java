package org.levk.network;

import org.bouncycastle.math.ec.ECPoint;
import org.bouncycastle.util.encoders.Hex;
import org.levk.crypto.ecdsa.ECIESCoder;
import org.levk.crypto.ecdsa.ECKey;
import org.levk.network.messages.Message;
import org.levk.util.Tuple;
import org.levk.util.serialization.RLP;
import org.levk.util.serialization.RLPElement;
import org.levk.util.serialization.RLPItem;
import org.levk.util.serialization.RLPList;
...
import static org.levk.network.Peer2Peer.commands;
import static org.levk.network.Peer2Peer.waitList;
import static org.levk.util.ByteUtil.ONE_BYTE;
import static org.levk.util.ByteUtil.ZERO_BYTE;
import static org.levk.util.NetUtil.deblobify;
import static org.levk.util.NetUtil.semiblobify;
        ...
        if (in.getMessageType() == 0x04) {
            try {
                ...
                for (int i = 0; i < peerlist.size(); i++) {
                    Peer2Peer.connect((new Peer(peerlist.get(i).getRLPData())).socket.getInetAddress().toString());
                }
            } catch (Exception e) {
